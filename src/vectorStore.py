...
class FaissVectorStore:
    def __init__(self, persist_dir: str= "faiss_store_3", model_name: str="all-MiniLM-L6-v2", embedding_model: str="all-MiniLM-L6-v2", chunk_size: int=1000, chunk_overlap: int= 200):
